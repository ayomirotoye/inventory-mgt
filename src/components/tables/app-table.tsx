                  ...
                  <TableHeader
                    ...
                    name={
                      <Switch
                        ...
                        onChange={switchAll}
                        className={`${
                          enabled.all ? "bg-primary-600" : "bg-gray-200"
                        } absolute inline-flex h-6 w-11 items-center rounded-full z-[999]`}
                      >
                        <span className="sr-only"></span>
                        <span
                          className={`${
                            enabled.all ? "translate-x-6" : "translate-x-1"
                      ...
                      <TableData className={tdClassName}>
                        {
                          <Switch
                            ...
                            onChange={() =>
                              setEnabled({
                                ...enabled,
                                [String(index)]: !enabled[String(index)],
                              })
                            }
                            className={`${
                              enabled[String(index)] || enabled.all
                                ? "bg-primary-600"
                                : "bg-gray-200"
                        ...
                        >
                          <div
                            className={`rounded-full ${
                              !isNullOrUndefined(dataItems["status"])
